      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-6 max-w-7xl mx-auto" style={{ height: '450px' }}>
          {whyUseItems.map((item) => (
            <div 
              key={item.id} 
              className={`relative bg-card shadow-2xl overflow-hidden transition-all duration-700 ease-out border border-primary/10 hover:border-accent/50 group ${
                hoveredCard === null 
                  ? 'flex-1' 
                  : hoveredCard === item.id 
                    ? 'flex-[2.2]' 
                ...
                <div className={`relative overflow-hidden transition-all duration-700 ease-out ${
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <span className="text-accent text-xs font-bold tracking-[0.3em] uppercase">Luxury</span>
                    </div>
