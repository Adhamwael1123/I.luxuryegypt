      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#" className="block hover:text-accent transition-colors">Cairo & Pyramids</a>
              <a href="#" className="block hover:text-accent transition-colors">Luxor & Valley of Kings</a>
              <a href="#" className="block hover:text-accent transition-colors">Aswan & Abu Simbel</a>
              <a href="#" className="block hover:text-accent transition-colors">Red Sea Resorts</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                <a 
                  href="#" 
                  className="text-primary-foreground hover:text-accent transition-colors hover-elevate p-2 rounded-full"
