...
export default function DestinationBlocks() {
  ...
  return (
    <section className="py-8 bg-background" data-testid="destination-blocks-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Journey beyond the ordinary to exclusive sanctuaries where ancient wonders meet modern sophistication.
          </p>
        </div>
